...
const data = {
  address: 'Москва, 2-я рощинская, 3',
  phone: '+7 (999) 999 99 99',
  mail: 'alina@alina.com',
  schedule: '9:00 - 00:00',
  socials: {
    vk: 'https://vk.com/',
    telegram: 'https://t.me/Adeliince',
    instagram: '',
  },
}

const Contacts = () => {
  const { phone, address, schedule, socials } = data
  return navigation.contacts ? (
    ...
    >
      <div className={'container-max-width grid p-10'}>
        ...
        <div className="text-sm space-y-2 grid md:grid-cols-3 gap-1">
          <p className={'m-0'}>
            <strong>Адрес:</strong>{' '}
            <Link
              className="text-blue-600 cursor-pointer"
              target={'_blank'}
              href={'https://yandex.ru/maps/-/CHTkFLZA'}
              rel="noreferrer"
            >
              {address}
            </Link>
